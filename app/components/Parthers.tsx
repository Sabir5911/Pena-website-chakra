    ...
    <Box bg='#09121D'   >
      <Container maxWidth={'1440px'}>
        ...
        <Box color={'#11AD8E'} fontFamily='inherit' >
          <RevealWrapper origin='top' delay={300} duration={1000} distance='100px' reset={true}> <Heading textAlign={'center'} justifyContent='center' fontSize={'60px'} pt='100px'>Our Partners</Heading></RevealWrapper>
